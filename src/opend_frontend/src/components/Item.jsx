...
function Item(props) {
  ...
  async function handleBuy() {
    setLoaderHidden(false);
    const token_backendActor = await Actor.createActor(tokenIdlFactory, {
      agent,
    ...
    const result = await token_backendActor.transfer(sellerId, itemPrice);
    if (result == "Success") {
